...
from cfehome.custom_storage.custom_azure import AzureProtectedStorage
...
# PROTECTED_FILE_STORAGE = settings.PROTECTED_FILE_STORAGE
# protected_storage = FileSystemStorage(location=str(PROTECTED_FILE_STORAGE))
...
class ProductAttachment(models.Model):
    ...
    def get_protected_url(self):
        return self.file.storage.get_protected_url(self.file.name)
